  ...
  return (
    <HeaderWrap hideBak={hideBak}>
      <InHead>
        ...
        <HeaderBtnBox>
          <LoginBtn><Link to ="/Login">{LoginSucss ? '마이페이지' : '로그인'}</Link></LoginBtn>
          <JoinBtn joinBtnColor={joinBtnColor}><Link to ="/Join">{LoginSucss ? '로그아웃' : '회원가입'}</Link></JoinBtn>
        </HeaderBtnBox>
      </InHead>
    </HeaderWrap>
  );
